...
export default function FloorPage() {
  return (
    <main className="bg-exbr-bg min-h-screen text-white">
      ...
      {/* Intro strip */}
      <section className="relative overflow-hidden px-6 py-14 text-center border-b-4 border-exbr-line scanlines">
        <div className="relative z-10">
          <div className="inline-block font-pixel text-[10px] text-exbr-amber border-2 border-exbr-amber px-3 py-2 mb-6 animate-pulse">
            WHITELIST APPLICATIONS OPEN
          </div>
          <h1 className="font-pixel text-xl md:text-3xl leading-relaxed mb-4">
            EVERY MOGUL<br />
            STARTS ON THE <span className="text-exbr-amber">FLOOR</span>
          </h1>
          <p className="font-mono text-sm text-white/60 max-w-lg mx-auto">
      ...
      <footer className="px-6 py-10 border-t-4 border-exbr-line flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-6 font-mono text-xs text-white/50">
          <a href="https://x.com/Moguls_nfts" target="_blank" className="hover:text-white">X / Twitter</a>
